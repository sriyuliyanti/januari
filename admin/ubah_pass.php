...
$query = mysql_fetch_array(mysql_query("SELECT password FROM guru WHERE nip = '$_SESSION[user]'"));
if($query['password']==$lama){
$sql = mysql_query("UPDATE guru SET password='$baru' WHERE nip = '$_SESSION[user]'");
